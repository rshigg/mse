...
import { ChatMessageType } from 'comms/types/ChatMessageType';
...
export const ChatMessagesProvider: FC = ({ children }) => {
  return (
    <ChatMessagesContext.Provider value={chatMessagesSubject}>
      {children}
...
export const useChatMessages = () => {
  ...
  useEffect(() => {
    const subscription = chatMessagesSubject.subscribe((chatMessage: ChatMessageType) => {
